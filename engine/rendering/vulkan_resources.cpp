...
void createDescriptorPool(
    ...
    uint32_t maxSets = meshCount * imageCount;
...
void createDescriptorSets(
    ...
    for (auto& [modelPath, meshResources] : meshCache) {
        ...
        meshResources.descriptorSets.resize(imageCount);
...
void createColorResources(
    ...
    createImage(device, physicalDevice, swapChainExtent.width, swapChainExtent.height, 1, msaaSamples, swapChainImageFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, colorImage, colorImageMemory);
...
void createDepthResources(
    ...
    createImage(device, physicalDevice, swapChainExtent.width, swapChainExtent.height, 1, msaaSamples, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
